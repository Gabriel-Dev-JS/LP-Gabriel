        ...
        <div className={styles.Apresentacao}>
            <div className={styles.sobre}>
                ...
                <div style={{fontSize:"32px", display:"flex", flexDirection:"column"}}>
                    <p style={{margin:"0px", maxWidth:"800px"}}>Me chamo Gabriel, sou formado em Análise e Desenvolvimento de Sistemas Trabalho há mais de dois anos com desenvolvimento de software</p>
