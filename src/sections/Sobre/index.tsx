        ...
        <div className={styles.Apresentacao} id="sobre">
            <div className={styles.sobre}>
                ...
                <div className={styles.containerTexto}>
                    <p className={styles.texto}>Me chamo Gabriel, sou formado em Análise e Desenvolvimento de Sistemas e atuo há mais de dois anos na área de desenvolvimento de software</p>
                </div>
            </div>
